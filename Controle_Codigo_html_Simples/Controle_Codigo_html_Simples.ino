...
void loop() {
  ...
  if (client) {
    ...
    client.println("<p>127 : 255</p>");
    client.println("<p><input type='number' id='power' min='127' max='255' value='0'></p>");
    client.println("<p>");
    ...
    client.println("<button onmousedown=\"fetch('/move=foward?power=' + document.getElementById('power').value)\" onmouseup=\"fetch('/move=stop')\">↑</button>");
    client.println("</p>");
    /*client.println("<p>");
    ...
    client.println("<button onmousedown=\"fetch('/move=stop?power=' + document.getElementById('power').value)\" onmouseup=\"fetch('/move=stop')\">■</button>");    
    client.println("</p>");
    client.println("<p>");
    ...
    client.println("<button onmousedown=\"fetch('/move=backward?power=' + document.getElementById('power').value)\" onmouseup=\"fetch('/move=stop')\">↓</button>");
    client.println("</p>");
