...
void loop() {
  ...
  if (client) {
    ...
    if (request.indexOf("/move/") != -1) {
      ...
      controlarMovimento(comando, comandoIndex);
    }
    ...
    client.print("</head><body><header style=\"display:flex;gap:2rem;flex-direction:column;align-items:center;\"><h1>ESP32 Web Server</h1></header><div><button onmousedown=\"move('5')\" onmouseup=\"0\" ontouchstart=\"move('5')\" ontouchend=\"0\">↖</button><button onmousedown=\"move('1')\" onmouseup=\"0\" >↑</button><button onmousedown=\"move('6')\" onmouseup=\"0\" ontouchstart=\"move('6')\" ontouchend=\"0\">↗</button><button onmousedown=\"move('4')\" onmouseup=\"0\" ontouchstart=\"move('4')\" ontouchend=\"0\">←</button><button onmousedown=\"0\" ontouchstart=\"0\">■</button><button onmousedown=\"move('3')\" onmouseup=\"0\" ontouchstart=\"move('3')\" ontouchend=\"0\">→</button><button onmousedown=\"move('8')\" onmouseup=\"0\" ontouchstart=\"move('8')\" ontouchend=\"0\">↙</button><button onmousedown=\"move('2')\" onmouseup=\"0\" ontouchstart=\"move('2')\" ontouchend=\"0\">↓</button><button onmousedown=\"move('7')\" onmouseup=\"0\" ontouchstart=\"move('7')\" ontouchend=\"0\">↘</button></div></body></html>");
...
void controlarMovimento(double comando[][4], int comandoIndex) {
  digitalWrite(m1t1_Motor1, comando[comandoIndex][0]);
  analogWrite(m1t2_Motor1, comando[comandoIndex][1]);
  analogWrite(m1t1_Motor2, comando[comandoIndex][2]);
  digitalWrite(m1t2_Motor2, comando[comandoIndex][3]);
}
